...
export const header_nav_items_children_grandchildren = sqliteTable(
  'header_nav_items_children_grandchildren',
  {
    _order: integer('_order').notNull(),
    _parentID: text('_parent_id').notNull(),
    id: text('id').primaryKey(),
    item_link_type: text('item_link_type', { enum: ['reference', 'custom'] }).default('reference'),
    item_link_newTab: integer('item_link_new_tab', { mode: 'boolean' }),
    item_link_url: text('item_link_url'),
    item_link_label: text('item_link_label').notNull(),
  },
  (columns) => ({
    _orderIdx: index('header_nav_items_children_grandchildren_order_idx').on(columns._order),
    _parentIDIdx: index('header_nav_items_children_grandchildren_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [header_nav_items_children.id],
      name: 'header_nav_items_children_grandchildren_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const header_nav_items_children = sqliteTable(
  ...
  (columns) => ({
    _orderIdx: index('header_nav_items_children_order_idx').on(columns._order),
    _parentIDIdx: index('header_nav_items_children_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
...
export const relations_header_nav_items_children_grandchildren = relations(
  header_nav_items_children_grandchildren,
  ({ one }) => ({
    _parentID: one(header_nav_items_children, {
      fields: [header_nav_items_children_grandchildren._parentID],
...
export const relations_header_nav_items_children = relations(
  ...
  ({ one, many }) => ({
    ...
    grandchildren: many(header_nav_items_children_grandchildren, {
      relationName: 'grandchildren',
    }),
  }),
)
...
type DatabaseSchema = {
  ...
  header_nav_items_children_grandchildren: typeof header_nav_items_children_grandchildren
  ...
  relations_header_nav_items_children_grandchildren: typeof relations_header_nav_items_children_grandchildren
