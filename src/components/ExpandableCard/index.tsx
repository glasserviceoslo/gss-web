    ...
    <>
          ...
          <div className="fixed inset-0 grid place-items-center z-100">
            ...
            >
              <motion.div
                ...
                className="w-[70%] aspect-3/2 mx-auto"
              >
                <img
                  src={active.image}
                  alt={active.imageAlt}
                  ...
                  <div className="flex items-end justify-between w-full">
                    ...
                    {content.anchorText ? (
                      <motion.button
                        ...
                        className={cn(
                          `${buttonVariants({ variant: 'default' })} dark:text-white ml-auto`,
                        )}
                      >
                        {content.anchorText}
                      </motion.button>
      ...
      >
        <div className="flex gap-4 flex-col w-full">
          <motion.div
            layoutId={`image-${content.title}-${id}`}
            className="w-[70%] aspect-3/2 mx-auto"
          >
            <img
              src={content.image}
