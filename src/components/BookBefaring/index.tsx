...
export function BookBefaring({ pulsate = false, text = 'Gratis Befaring' }) {
  ...
  return (
    <button {...commonProps} className="btn-primary hidden md:block">
      <span className="hidden pointer-events-none lg:block">{text}</span>
      <svg
        ...
        strokeWidth="1.5"
        stroke="currentColor"
        className="hidden h-6 w-6 md:block lg:hidden"
      >
        <path
          strokeLinecap="round"
